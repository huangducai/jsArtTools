...
connection.connect(function(err) {
    ...
    var dirList = _.without(fs.readdirSync(xlsxConfigPath),'.DS_Store');
...
function createTabel(tableName, cb){
    ...
    connection.query(sql,function(err, rows) {
        ...
        //cb()
        importExcelToTabel(name[0], obj[1].data,cb)
    });
}
 ...
 * @param cb
 */
function importExcelToTabel(tableName, data, cb) {
